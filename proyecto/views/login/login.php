...
if ($stmt->num_rows > 0) {
    ...
    if (password_verify($pass, $hashed_pass)) {
        ...
        echo "<a href='/proyecto/views/pagina_login.php'>Click aqui</a> para volver a intentar o espera 5 segundos y serás redirigido";
        // JavaScript para redireccionar automáticamente
        echo "<script>
                setTimeout(function(){
                    window.location.href = '/proyecto/views/pagina_login.php';
                }, 5000);
              </script>";
    }
} else {
