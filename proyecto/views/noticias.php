    ...
    <main>
        ...
        <?php include('../scripts/mensaje_cambio.php'); ?>
            ...
            <?php if (isset($role) && $role == 'admin') { ?>
                ...
                <form action="/proyecto/views/noticias/subir_noticia.php" method="post" enctype="multipart/form-data">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="news-item" id="form_info-<?php echo $idNoticia; ?>">
                        ...
                        <img src="/proyecto/<?php echo htmlspecialchars($row['imagen']); ?>" alt="Imagen de la noticia" class="news-image">
                    ...
                    <div class="news-item-form" id="form-<?php echo $idNoticia; ?>" style="display: none;">
                        <form action="noticias/modificar_noticia.php" method="post" enctype="multipart/form-data">
                            ...
                            <label for="imagen">Imagen:</label><br>
                            <img src="/proyecto/<?php echo htmlspecialchars($row['imagen']); ?>" alt="Imagen actual" class="news-image">
