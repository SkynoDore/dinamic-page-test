...
<body>
    ...
    <form action="/proyecto/views/perfil/cambio_contraseña.php">
        <button class="btn btn-secondary m-2 w-100 " type="submit">Cambiar contraseña</button>
    </form>
    <form action="/proyecto/views/perfil/eliminar_usuario.php">
        ...
        <form method="post" action="/proyecto/views/admin_usuarios.php" class="p-3 my-3">
