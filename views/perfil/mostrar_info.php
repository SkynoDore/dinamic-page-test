...
<form id="userForm" method="post" action="perfil/actualizar_info.php" class="p-3 my-3">
    ...
    <?php } ?>
        ...
        <input required class="form-control" type="text" id="nombre" name="nombre" pattern="[A-Za-záéíóúüÁÉÍÓÚÜñÑ ]{3,30}" maxlength="30" value='<?php echo htmlspecialchars($nombre); ?>'><br>

        <label for='apellidos'>Apellidos</label>
        <input required class="form-control" type="text" id="apellidos" name="apellidos" pattern="[A-Za-záéíóúüÁÉÍÓÚÜñÑ ]{3,30}" maxlength="30" value='<?php echo htmlspecialchars($apellidos); ?>'><br>
        ...
        <input required class="form-control" type="text" id="direccion" name="direccion" pattern="[A-Za-z0-9áéíóúüÁÉÍÓÚÜñÑ.,\- ]{5,255}" maxlength="255" value='<?php echo htmlspecialchars($direccion); ?>'><br>
